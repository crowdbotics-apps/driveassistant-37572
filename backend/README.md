...
## Project Structure
    ...
    ├── driveassistant_37572  # Django project configurations
...
1. Clone this repo and `cd driveassistant_37572`
...
2. Clone this repo and `cd driveassistant_37572`
